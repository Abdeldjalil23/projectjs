      ...
      <form onSubmit={handleSave} className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <h1 className="text-2xl font-bold tracking-tight">
            CONSOLIDATION TRIMESTRIELLE DES ACTIVITES DE MEDECINE DU TRAVAIL
          </h1>
          <Button>
        ...
        <Accordion type="multiple" className="w-full">
          {/* Appointment Trends */}
          <AccordionItem value="appointment-trends">
            <AccordionTrigger>Appointment Trends</AccordionTrigger>
            <AccordionContent>
              <Card>
                <CardHeader>
          ...
          {/* Department Stats */}
          <AccordionItem value="department-stats">
            <AccordionTrigger>Department Statistics</AccordionTrigger>
            <AccordionContent>
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
          ...
          {/* Doctor Performance */}
          <AccordionItem value="doctor-performance">
            <AccordionTrigger>Doctor Performance Metrics</AccordionTrigger>
            <AccordionContent>
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
          ...
          {/* Recent Reports */}
          <AccordionItem value="recent-reports">
            <AccordionTrigger>Recent Reports</AccordionTrigger>
            <AccordionContent>
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center">
